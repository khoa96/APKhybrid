                ...
                <span class="icon-checked">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g clip-path="url(#clip0_609_14696)">
                      <path d="M7.33301 12.0003L10.6663 15.3337L17.333 8.66699" stroke="white" stroke-width="2"
                    ...
                    <span class="icon-option">
                      <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g clip-path="url(#clip0_609_14689)">
                          <path d="M3.66699 5.99967L5.33366 7.66634L8.66699 4.33301" stroke="white" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round" />
                        </g>
                        <defs>
              ...
              <div class="choose-payment-type-wrapper">
                <div id="choose-payment-type-tabs">
                  <ul class="list-payment-type">
                    <li>
                      <a href="#tabs-3" class="payment-type-item">
                        <div class="tab-label">
                            ...
                            <span class="checked">
                              <span class="icon-checked">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                  ...
                                  <rect x="1" y="1" width="22" height="22" rx="11" fill="#034F76" />
                        ...
                        <div class="tab-label">
                          ...
                          <div class="payment-info">
                            <h5 class="payment-title">
                              ...
                              <img src="./images/stripe-image.png" alt="" class="stripe-image">
                            </h5>
                            <div class="list-payment">
                              <div class="payment-item">
                      ...
                      <a href="#tabs-2" class="payment-type-item">
                        <div class="tab-label">
                          ...
                          <div class="payment-info">
                            <h5 class="payment-title">
                              <span>Credit Card by</span>
                              <img src="./images/paypal-image.png" alt="" class="paypal-image">
                            </h5>
                            <div class="list-payment">
                              <div class="payment-item">
                  ...
                  <span class="icon">
                    ...
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_609_14609)">
                        <path d="M3.33301 8.00033L6.66634 11.3337L13.333 4.66699" stroke="#F1516E" stroke-width="1.5"
                          stroke-linecap="round" stroke-linejoin="round" />
                      </g>
                      <defs>
