...
<body>
  ...
  <div class="see-all-page__wrapper">
    <div class="container">
      <!-- CATEGORY LIST START -->
      ...
      <h2 class="common-page-title">Discover</h2>
      ...
      <div class="common-layout__wrapper">
        ...
        <div class="common-layout__left">
          <div class="common-list-discover">
            <a href="#" target="" title="" class="common-discover__item">
              <div class="left-content">
                ...
                <div class="info-wrapper">
                  <h3 class="app-title text-overflow">Gangstar New York Gangstar New York Gangstar New York Gangstar New
                    York</h3>
            ...
            <a href="#" target="" title="" class="common-discover__item">
              <div class="left-content">
                ...
                <div class="info-wrapper">
                  <h3 class="app-title text-overflow">Gangstar New York Gangstar News
                    York</h3>
                  <span class="app-category">Action</span>
                  <div class="download-info__wrapper">
                    <div class="item-info">
