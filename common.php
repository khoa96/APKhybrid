...
<!-- common block item of right sidebar -->
<div class="common-right-sidebar-block__wrapper">
  <h3 class="common-right-sidebar-block__title"></h3>
  <h3 class="common-right-sidebar-block__content"></h3>
