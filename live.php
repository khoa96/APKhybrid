                                        ...
                                        <span class="icon-refresh">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke-linejoin="round" />
                                                <path d="M13.4418 4.43317L11.0334 1.6665" stroke="#1A202C"
                                                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M13.4416 4.43311L10.6333 6.48311" stroke="#1A202C"
                                                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        </span>
            ...
            <div class="container">
                <div class="main-layout">
                    <div class="middle-layout main-content-match-page">
                        <div id="match-tabs">
                            <ul class="sub-nav">
                                <li class="match-tab-item">
                                    <h2><a href="#tabs-0">Match</a></h2>
                                </li>
                                <li class="match-tab-item">
                                    <h2><a href="#tabs-1">Overview</a></h2>
                                </li>
                                <li class="match-tab-item">
                                    <h2><a href="#tabs-2">Lineups</a></h2>
                                </li>
                                <li class="match-tab-item">
                                    <h2><a href="#tabs-3">H2H</a></h2>
                                </li>
                                <li class="match-tab-item">
                                    <h2><a href="#tabs-4">Standings</a></h2>
                                </li>
                                <li class="match-tab-item">
                                    <h2><a href="#tabs-5">Statistics</a></h2>
                                </li>
                            </ul>
                                    ...
                                    <div class="common-home-league-table">
                                        <div class="table-row">
                                            <div class="left-column">
                                                <div class="league-name">Premier League League Premier League</div>
                                                        ...
                                                        <div class="list-club-wrapper">
                                                            <div class="club-item">
                                                                <div class="club-info-wrapper">
                                                                    ...
                                                                    <span
                                                                        class="club-name macth-text-overflow-club  txt-primary">Manchester
                                                                        City
                                                                    </span>
                                                                </div>
                                                            </div>
                                                            <div class="club-item">
                                                                <div class="club-info-wrapper">
                                                                    ...
                                                                    <span
                                                                        class="club-name macth-text-overflow-club  txt-secondary">Chelsea</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="list-club-wrapper">
                                                            ...
                                                            <div class="club-item">
                                                                <div class="club-info-wrapper">
                                                                    <img src="./images/club-2.png" alt="">
                                                                    <span
                                                                        class="club-name macth-text-overflow-club txt-secondary">Chelsea
                                                                        Manchester
                                                ...
                                                <div class="timeline-box left-timeline">
                                                    <div class="list-player">
                                                        <div class="player-item">
                                                            <span class="icon">
                                                                <svg id="arrow-green" width="14" height="14"
                                                        ...
                                                        <div class="player-item">
                                                            <span class="icon">
                                                                ...
                                                                <svg id="arrow-red" width="14" height="14"
                                                                    viewBox="0 0 14 14" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div class="list-player">
                                                        <div class="player-item">
                                                            <span class="icon">
                                                                ...
                                                                <svg id="icon-soccer" width="16" height="16"
                                                        ...
                                                        <div class="player-item">
                                                            <span class="icon">
                                                                <svg id="icon-run-shoe" width="16" height="16"
                                                                    viewBox="0 0 16 16" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <rect x="16" y="16" width="16" height="16"
                                                                        transform="rotate(-180 16 16)" fill="white" />
                                                                    <path
                                                                        ...
                                                                        fill="#2C7A7B" />
                                                                    <path d="M8 12.6665H1V13.8332H8V12.6665Z"
                                                                        fill="#2C7A7B" />
                                                                    <path d="M3.91667 9.75H1V10.9167H3.91667V9.75Z"
                                                                        fill="#2C7A7B" />
                                                                </svg>
                                                            </span>
                                                    ...
                                                    <div class="list-player">
                                                        <div class="player-item">
                                                            <span class="icon">
                                                                ...
                                                                <svg id="icon-yellow-card" width="16" height="16"
                                                                    viewBox="0 0 16 16" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <rect x="2.3999" y="1" width="11.2" height="14"
                                                                        rx="3" fill="#FAC712" />
                                                                </svg>
                                                        ...
                                                        <div class="player-item">
                                                            <span class="icon">
                                                                ...
                                                                <svg id="icon-red-card" width="16" height="16"
                                                                    viewBox="0 0 16 16" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <rect x="2.3999" y="1" width="11.2" height="14"
                                                                        rx="3" fill="#E53E3E" />
                                            ...
                                            <div class="timeline-item">
                                                <div class="timeline-box left-timeline">
                                                    <div class="list-player">
                                                        <div class="player-item">
                                                            <span class="icon">
                                                                <svg id="icon-green-pen" width="20" height="20"
                                                                    viewBox="0 0 20 20" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <rect x="3" y="3" width="14" height="14" rx="7"
                                                                        fill="white" />
                                                                    <path
                                                        ...
                                                        <div class="player-item">
                                                            <span class="icon">
                                                                <svg id="icon-red-pen" width="20" height="20"
                                                                    viewBox="0 0 20 20" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <rect x="3" y="3" width="14" height="14" rx="7"
                                                                        fill="white" />
                                                    ...
                                                    <div class="list-player">
                                                        <div class="player-item">
                                                            <span class="icon">
                                                                ...
                                                                <svg id="icon-red-soccer" width="16" height="16"
                                                                    viewBox="0 0 16 16" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <path
                                                                        d="M5.6665 7.4165L6.83317 9.74984H9.1665L10.3332 7.4165L7.99984 5.6665L5.6665 7.4165Z"
                                                        ...
                                                        <div class="player-item">
                                                            <span class="icon">
                                                                ...
                                                                <svg id="icon-second-yellow" width="16" height="16"
                                                                    viewBox="0 0 16 16" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#clip0_164_3822)">
                                                                        <rect x="5.9917" width="10.017" height="12.5213"
                                                                            rx="1" transform="rotate(9.47935 5.9917 0)"
                                                                            fill="#E53E3E" />
                                                                        <rect x="0.518555" y="3.39746" width="10.2638"
                                                                            height="12.8297" rx="1"
                                                                            transform="rotate(-8.38283 0.518555 3.39746)"
                                                                            fill="#FAC712" />
                                                                    </g>
                                                                    <defs>
                                                        ...
                                                        <div class="list-club-wrapper">
                                                            <div class="club-item">
                                                                <div class="club-info-wrapper">
                                                                    <img src="./images/club-1.png" alt="">
                                                                    <span
                                                                        class="club-name text-overflow-club txt-primary">Manchester
                                                                        City </span>
                                                                </div>
                                                            ...
                                                            <div class="club-item">
                                                                <div class="club-info-wrapper">
                                                                    <img src="./images/club-2.png" alt="">
                                                                    <span
                                                                        class="club-name text-overflow-club txt-secondary">Chelsea</span>
                                                                </div>
                                    ...
                                    <div class="visual-club-wrapper">
                                                    ...
                                                    <div class="list-card">
                                                        <div class="card-item">
                                                            <svg id="icon-yellow-card" width="16" height="16"
                                                                viewBox="0 0 16 16" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <rect x="2.3999" y="1" width="11.2" height="14" rx="3"
                                                                    fill="#FAC712" />
                                                            </svg>
                                        ...
                                        <div class="club-info club-info-1">
                                            <div class="info-wrapper">
                                                <span class="club-name">Man United</span>
                                                <span class="detail">First XI average age <strong>27.7
                                                        yrs</strong></span>
                                            </div>
                                        ...
                                        <div class="list-player">
                                            <div class="player-item">
                                                ...
                                                <div class="user-info-wrapper">
                                                    <span class="username">Pep Guardiola Pep Guardiola Pep Guardiola Pep
                                            ...
                                            <div class="player-item">
                                                <img src="./images/avatar-user.png" alt="" class="avatar-user">
                                                <div class="user-info-wrapper">
                                                    <span class="username">18 Stefan Ortega Pep Guardiola Pep Guardiola
                                                        Pep Guardiola</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="player-item">
                                                <img src="./images/avatar-user.png" alt="" class="avatar-user">
                                                <div class="user-info-wrapper">
                                                    <span class="username">21 Sergio Gomez Pep Guardiola Pep Guardiola
                                                        Pep Guardiola Pep
                                                    ...
                                                    <div class="major">
                                                        <span class="icon">
                                                            ...
                                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M5.96672 5.47998L3.48669 3L1.00671 5.47998"
                                                                    stroke="#0DC66D" stroke-width="2"
                                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                                <path d="M3.48669 13V3" stroke="#0DC66D"
                                                                    stroke-width="2" stroke-linecap="round"
                                                                    stroke-linejoin="round" />
                                                                <path d="M10.0333 10.52L12.5133 13L14.9933 10.52"
                                                                    stroke="#E53E3E" stroke-width="2"
                                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                                <path d="M12.5134 3V13" stroke="#E53E3E"
                                                                    stroke-width="2" stroke-linecap="round"
                                                                    stroke-linejoin="round" />
                                                            </svg>
                            ...
                            <div id="tabs-3" class="match-tab-content">
                                ...
                                <p class="suggestion-txt">Last 15 , Newcastle United Win <span
                                        class="txt-success">3</span>, Draw 1 ,
                                    ...
                                    <div id="tabs-1" class="match-sub-tabs">
                                        <div class="statistics-tab-content-wrapper">
                                            ...
                                            <div class="table-row">
                                                ...
                                                <div class="table-column d-flex flex-end statistics-danger">396 (84%)
                                                </div>
                                            </div>
    ...
    function countdown(elementName, minutes, seconds) {
        ...
        function updateTimer() {
            ...
            if (msLeft < 1000) {
                ...
                element.innerHTML = (hours ? twoDigits(hours) + ':' + twoDigits(mins) : twoDigits(mins)) + ':' +
                    twoDigits(time
                        .getUTCSeconds());
