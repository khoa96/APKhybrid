    ...
    <div class="container">
      ...
      <div class="common-section-layout__wrapper mt-24 mb-24">
        <div class="common-section-layout__header">
          <h2 class="common-section-layout__title">Tools Apps</h2>
      ...
      <!-- COMMUNICATION APPS START -->
      <div class="common-section-layout__wrapper mt-24 mb-24">
        <div class="common-section-layout__header">
          <h2 class="common-section-layout__title">Communication Apps</h2>
          <a href="#" class="common-section-layout__btn-see-all" target="" title="">
            <span class="text">See all</span>
            <img src="./images/icon-green-arrow.png" class="icon-arrow" alt="">
          </a>
      ...
      <!-- COMMUNICATION APPS  END-->

      <!-- SOCIAL APPS START -->
      <div class="common-section-layout__wrapper mt-24 mb-24">
        <div class="common-section-layout__header">
          <h2 class="common-section-layout__title">Social Apps</h2>
          <a href="#" class="common-section-layout__btn-see-all" target="" title="">
            <span class="text">See all</span>
            <img src="./images/icon-green-arrow.png" class="icon-arrow" alt="">
          </a>
      ...
      <!-- ENTERTAINMENT  APPS START -->
      <div class="common-section-layout__wrapper mt-24 mb-24">
        <div class="common-section-layout__header">
          <h2 class="common-section-layout__title">Entertainment Apps</h2>
          <a href="#" class="common-section-layout__btn-see-all" target="" title="">
            <span class="text">See all</span>
            <img src="./images/icon-green-arrow.png" class="icon-arrow" alt="">
          </a>
      ...
      <!-- PRODUCT ACTIVITY BLOCK  END -->

      <!-- SHOPPING APPS BLOCK START -->
      <div class="common-section-layout__wrapper mt-24 mb-24">
        <div class="common-section-layout__header">
          <h2 class="common-section-layout__title">Shopping Apps</h2>
          <a href="#" class="common-section-layout__btn-see-all" target="" title="">
            <span class="text">See all</span>
            <img src="./images/icon-green-arrow.png" class="icon-arrow" alt="">
          </a>
